<div id="kt_header" class="kt-header  kt-header--fixed " data-ktheader-minimize="on">
        <div class="kt-container kt-container--fluid">
            ...
            <div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
                <a class="kt-header__brand-logo" href="{{route('admin.dashboard')}}">
                        ...
                        <div class="kt-user-card kt-user-card--skin-light kt-notification-item-padding-x">
                            <div class="kt-user-card__avatar">
                                ...
                                @if(!empty(Auth::guard('admin')->user()->photo))
                                    <img class="kt-hidden-" alt="{{Auth::guard('admin')->user()->name}}" src="{{asset(FOLDER_PATH.ADMIN_PHOTO.Auth::guard('admin')->user()->photo)}}" />
                                @else
                                    <img class="kt-hidden-" alt="{{Auth::guard('admin')->user()->name}}" src="{{asset('public/'.COMMON_IMG.json_decode(DEFAULT_PHOTO)[Auth::guard('admin')->user()->gender])}}" />
                                @endif
                                <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                                {{-- <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold kt-hidden">S</span> --}}
                            </div>
                            <div class="kt-user-card__name font-weight-bold">
                                    <span class="text-brand">{{Auth::guard('admin')->user()->name}}</span>
                            </div>
