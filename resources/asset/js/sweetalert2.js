! function (t, e) {
    ...
    function y(e, t, n) {
        m(e.classList).forEach(function (t) {
            -1 === p(B).indexOf(t) && -1 === p(x).indexOf(t) && e.classList.remove(t)
        }), t && t[n] && it(e, t[n])
    }
    var e = "SweetAlert2:",
        w = function (t) {
        ...
        B = t(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "toast", "toast-shown", "toast-column", "fade", "show", "hide", "noanimation", "close", "title", "header", "content", "actions", "confirm", "cancel", "footer", "icon", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl"]),
    ...
    function D() {
        var t = R();
        return m(t.querySelectorAll("." + B.icon))
    }
    ...
    function F() {
        return I(B["progress-steps"])
    }

    function W() {
        return I(B["validation-message"])
    }

    function K() {
        return q("." + B.actions + " ." + B.confirm)
    }

    function Z() {
        return q("." + B.actions + " ." + B.cancel)
    }
    ...
    function G() {
        return !st() && !document.body.classList.contains(B["no-backdrop"])
    }
    ...
    function et(t) {
        le.isVisible() && ot !== t.target.value && le.resetValidationMessage(), ot = t.target.value
    }

    function nt(t, e) {
        t instanceof HTMLElement ? e.appendChild(t) : "object" === f(t) ? lt(e, t) : t && (e.innerHTML = t)
    }
    var ot, it = function (t, e) {
            E(t, e, !0)
        },
        rt = function (t, e) {
            E(t, e, !1)
        ...
        ct = function (t) {
            if (function () {
                    var t = j();
                    t && (t.parentNode.removeChild(t), rt([document.documentElement, document.body], [B["no-backdrop"], B["toast-shown"], B["has-column"]]))
                }(), tt()) g("SweetAlert2 requires document to initialize");
            else {
                var e = document.createElement("div");
                e.className = B.container, e.innerHTML = ut;
                var n = function (t) {
                ...
                n.appendChild(e),
                    ...
                    function (t) {
                        "rtl" === window.getComputedStyle(t).direction && it(j(), B.rtl)
                    }(n),
                    function () {
                        var t = _(),
                            e = at(t, B.input),
                            n = at(t, B.file),
                            o = t.querySelector(".".concat(B.range, " input")),
                            i = t.querySelector(".".concat(B.range, " output")),
                            r = at(t, B.select),
                            a = t.querySelector(".".concat(B.checkbox, " input")),
                            s = at(t, B.textarea);
    ...
    function pt(t, e, n) {
        M(t, n["showC" + e.substring(1) + "Button"], "inline-block"), t.innerHTML = n[e + "ButtonText"], t.setAttribute("aria-label", n[e + "ButtonAriaLabel"]), t.className = B[e], y(t, n.customClass, e + "Button"), it(t, n[e + "ButtonClass"])
    }
    ...
    function ft(t, e) {
        var n = Q(),
            o = K(),
            i = Z();
        e.showConfirmButton || e.showCancelButton ? L(n) : O(n), y(n, e.customClass, "actions"), pt(o, "confirm", e), pt(i, "cancel", e), e.buttonsStyling ? function (t, e, n) {
            it([t, e], B.styled), n.confirmButtonColor && (t.style.backgroundColor = n.confirmButtonColor), n.cancelButtonColor && (e.style.backgroundColor = n.cancelButtonColor);
            var o = window.getComputedStyle(t).getPropertyValue("background-color");
            t.style.borderLeftColor = o, t.style.borderRightColor = o
        }(o, i, e) : (rt([o, i], B.styled), o.style.backgroundColor = o.style.borderLeftColor = o.style.borderRightColor = "", i.style.backgroundColor = i.style.borderLeftColor = i.style.borderRightColor = "")
    }
    ...
    function mt(t, e) {
        ...
        n && (function (t, e) {
            ...
            e in B ? it(t, B[e]) : (w('The "position" parameter is not valid, defaulting to "center"'), it(t, B.center))
        }(n, e.position), function (t, e) {
            if (e && "string" == typeof e) {
                var n = "grow-" + e;
                n in B && it(t, B[n])
            }
        }(n, e.grow), y(n, e.customClass, "container"), e.customContainerClass && it(n, e.customContainerClass))
    }
    ...
    var ht = {
        ...
        wt = function (t, e, n) {
            t.className = e, n.inputClass && it(t, n.inputClass), n.customClass && it(t, n.customClass.input)
        },
        Ct = {};
    Ct.text = Ct.email = Ct.password = Ct.number = Ct.tel = Ct.url = function (t) {
        var e = at(_(), B.input);
        return "string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : v(t.inputValue) || w('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(f(t.inputValue), '"')), gt(e, t), e.type = t.input, e
    }, Ct.file = function (t) {
        var e = at(_(), B.file);
        ...
        var e = at(_(), B.textarea);
        return e.value = t.inputValue, gt(e, t), e
    };

    function kt(t, e) {
        var n = _().querySelector("#" + B.content);
    ...
    function Bt(t, i) {
        ...
        L(r), r.innerHTML = "";
        var a = parseInt(null === i.currentProgressStep ? le.getQueueStep() : i.currentProgressStep);
        a >= i.progressSteps.length && w("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), i.progressSteps.forEach(function (t, e) {
            var n = function (t) {
                ...
                return it(e, B["progress-step"]), e.innerHTML = t, e
            }(t);
            if (r.appendChild(n), e === a && it(n, B["active-progress-step"]), e !== i.progressSteps.length - 1) {
                var o = function (t) {
                    var e = document.createElement("li");
                    return it(e, B["progress-step-line"]), t.progressStepsDistance && (e.style.width = t.progressStepsDistance), e
                }(t);
                r.appendChild(o)
            }
        })
    ...
    function xt(t, e) {
        var n = Y();
        y(n, e.customClass, "header"), Bt(0, e),
            function (t, e) {
                var n = ht.innerParams.get(t);
                if (n && e.type === n.type && N()) y(N(), e.customClass, "icon");
                else if (Pt(), e.type)
                    if (At(), -1 !== Object.keys(x).indexOf(e.type)) {
                        var o = q(".".concat(B.icon, ".").concat(x[e.type]));
            ...
            function (t, e) {
                ...
                L(n), n.setAttribute("src", e.imageUrl), n.setAttribute("alt", e.imageAlt), T(n, "width", e.imageWidth), T(n, "height", e.imageHeight), n.className = B.image, y(n, e.customClass, "image"), e.imageClass && it(n, e.imageClass)
            }(0, e),
            function (t, e) {
                var n = U();
    ...
    function St(t, e) {
        ! function (t, e) {
            var n = R();
            T(n, "width", e.width), T(n, "padding", e.padding), e.background && (n.style.background = e.background), n.className = B.popup, e.toast ? (it([document.documentElement, document.body], B["toast-shown"]), it(n, B.toast)) : it(n, B.modal), y(n, e.customClass, "popup"), "string" == typeof e.customClass && it(n, e.customClass), E(n, B.noanimation, !e.animation)
        }(0, e), mt(0, e), xt(t, e), kt(t, e), ft(0, e),
            function (t, e) {
                var n = $();
    ...
    function Et() {
        ...
        var e = Q(),
            n = K(),
            o = Z();
        L(e), L(n), it([t, e], B.loading), n.disabled = !0, o.disabled = !0, t.setAttribute("data-loading", !0), t.setAttribute("aria-busy", !0), t.focus()
    }
    ...
    var Mt = [],
        ...
        jt = ["title", "titleText", "text", "html", "type", "customClass", "showConfirmButton", "showCancelButton", "confirmButtonText", "confirmButtonAriaLabel", "confirmButtonColor", "confirmButtonClass", "cancelButtonText", "cancelButtonAriaLabel", "cancelButtonColor", "cancelButtonClass", "buttonsStyling", "reverseButtons", "imageUrl", "imageWidth", "imageHeigth", "imageAlt", "imageClass", "progressSteps", "currentProgressStep"],
        qt = {
        ...
        Rt = Object.freeze({
            ...
            queue: function (t) {
                ...
                function a(t, e) {
                    Mt = [], document.body.removeAttribute("data-swal2-queue-step"), t(e)
                }
                var s = [];
                return new Promise(function (i) {
                    ! function e(n, o) {
                        n < Mt.length ? (document.body.setAttribute("data-swal2-queue-step", n), r.fire(Mt[n]).then(function (t) {
    ...
    function Dt() {
        ...
        t.showConfirmButton || (O(e.confirmButton), t.showCancelButton || O(e.actions)), rt([e.popup, e.actions], B.loading), e.popup.removeAttribute("aria-busy"), e.popup.removeAttribute("data-loading"), e.confirmButton.disabled = !1, e.cancelButton.disabled = !1
    }
    ...
    function Wt(t, e, n, o) {
        n ? Yt(t, o) : (Tt().then(function () {
            ...
            if (b(document.body, B.iosfix)) {
                var t = parseInt(document.body.style.top, 10);
                rt(document.body, B.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * t
            }
        }(), "undefined" != typeof window && Ut() && window.removeEventListener("resize", _t), m(document.body.children).forEach(function (t) {
            t.hasAttribute("data-previous-aria-hidden") ? (t.setAttribute("aria-hidden", t.getAttribute("data-previous-aria-hidden")), t.removeAttribute("data-previous-aria-hidden")) : t.removeAttribute("aria-hidden")
        })), rt([document.documentElement, document.body], [B.shown, B["height-auto"], B["no-backdrop"], B["toast-shown"], B["toast-column"]])
    }
    ...
    function Kt(t) {
        ...
        if (e && !b(e, B.hide)) {
            ...
            if (n) {
                var o = Ft.swalPromiseResolve.get(this);
                rt(e, B.show), it(e, B.hide),
                    function (t, e, n) {
                        var o = j(),
                            i = dt && H(e),
                            r = n.onClose,
    ...
    var Qt = function (t, e, n, o) {
            Vt.swalCloseEventFinishedCallback = Wt.bind(null, t, n, st(), o), e.addEventListener(dt, function (t) {
        ...
        Yt = function (t, e) {
            setTimeout(function () {
                null !== e && "function" == typeof e && e(), R() || function (t) {
                    delete t.params, delete Vt.keydownHandler, delete Vt.keydownTarget, Zt(ht), Zt(Ft)
                }(t)
            })
        };
    ...
    function te(t) {
        ! function (e) {
            e.inputValidator || Object.keys(Gt).forEach(function (t) {
    ...
    var ne = function (t, e) {
            dt && H(e) ? (t.style.overflowY = "hidden", e.addEventListener(dt, ee.bind(null, e, t))) : t.style.overflowY = "auto"
        },
        oe = function (t, e) {
            ! function () {
                if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !b(document.body, B.iosfix)) {
                    var t = document.body.scrollTop;
                    document.body.style.top = -1 * t + "px", it(document.body, B.iosfix), zt()
                }
            }(), "undefined" != typeof window && Ut() && (_t(), window.addEventListener("resize", _t)), m(document.body.children).forEach(function (t) {
                t === j() || function (t, e) {
        ...
        ie = function (t, e, n) {
            n.animation && (it(e, B.show), it(t, B.fade)), L(e), it([document.documentElement, document.body, t], B.shown), n.heightAuto && n.backdrop && !n.toast && it([document.documentElement, document.body], B["height-auto"])
        },
        re = {
            ...
            radio: function (t, e, a) {
                ...
                e.forEach(function (t) {
                    ...
                    o.type = "radio", o.name = B.radio, o.value = e, a.inputValue.toString() === e.toString() && (o.checked = !0);
                    var r = document.createElement("span");
                    r.innerHTML = n, r.className = B.label, i.appendChild(o), i.appendChild(r), s.appendChild(i)
                });
    ...
    var se, ue = Object.freeze({
        hideLoading: Dt,
        disableLoading: Dt,
        getInput: function (t) {
            var e = ht.innerParams.get(t || this),
                n = ht.domCache.get(t || this);
            return n ? P(n.content, e.input) : null
        },
        close: Kt,
        closePopup: Kt,
        closeModal: Kt,
        ...
        enableButtons: function () {
            $t(this, ["confirmButton", "cancelButton"], !1)
        },
        disableButtons: function () {
            $t(this, ["confirmButton", "cancelButton"], !0)
        },
        enableConfirmButton: function () {
            h("Swal.disableConfirmButton()", "Swal.getConfirmButton().removeAttribute('disabled')"), $t(this, ["confirmButton"], !1)
        },
        disableConfirmButton: function () {
            h("Swal.enableConfirmButton()", "Swal.getConfirmButton().setAttribute('disabled', '')"), $t(this, ["confirmButton"], !0)
        },
        enableInput: function () {
            return Jt(this.getInput(), !1)
        },
        disableInput: function () {
            return Jt(this.getInput(), !0)
        },
        showValidationMessage: function (t) {
            ...
            var o = this.getInput();
            o && (o.setAttribute("aria-invalid", !0), o.setAttribute("aria-describedBy", B["validation-message"]), A(o), it(o, B.inputerror))
        },
        ...
        setProgressSteps: function (t) {
            ...
            Bt(0, e), ht.innerParams.set(this, e)
        },
        ...
        _main: function (t) {
            var c = this;
            ! function (t) {
                for (var e in t) Lt(i = e) || w('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== It.indexOf(o) && w('The parameter "'.concat(o, '" is incompatible with toasts'))), Ot(n = void 0) && h(n, Ot(n));
                var n, o, i
            }(t), R() && Vt.swalCloseEventFinishedCallback && (Vt.swalCloseEventFinishedCallback(), delete Vt.swalCloseEventFinishedCallback), Vt.deferDisposalTimer && (clearTimeout(Vt.deferDisposalTimer), delete Vt.deferDisposalTimer);
            var l = a({}, Ht, t);
            te(l), Object.freeze(l), Vt.timeout && (Vt.timeout.stop(), delete Vt.timeout), clearTimeout(Vt.restoreFocusTimeout);
            var d = {
                popup: R(),
                container: j(),
                content: _(),
            ...
            ht.domCache.set(this, d), St(this, l), ht.innerParams.set(this, l);
            ...
            return new Promise(function (t) {
                ...
                Ft.swalPromiseResolve.set(c, t), l.timer && (Vt.timeout = new Xt(function () {
                ...
                if (d.closeButton.onclick = function () {
                    ...
                    d.popup.onmousedown = function () {
                        ...
                        r ? r = !1 : t.target === d.container && C(l.allowOutsideClick) && s(p.DismissReason.backdrop)
                    }
                }
                ...
                function a(t, e) {
                    for (var n = X(l.focusCancel), o = 0; o < n.length; o++) return (t += e) === n.length ? t = 0 : -1 === t && (t = n.length - 1), n[t].focus();
                    d.popup.focus()
                }
                Vt.keydownTarget && Vt.keydownHandlerAdded && (Vt.keydownTarget.removeEventListener("keydown", Vt.keydownHandler, {
                        capture: Vt.keydownListenerCapture
                    }), Vt.keydownHandlerAdded = !1), l.toast || (Vt.keydownHandler = function (t) {
                        return function (t, e) {
                    ...
                    }, Vt.keydownTarget = l.keydownListenerCapture ? window : d.popup, Vt.keydownListenerCapture = l.keydownListenerCapture, Vt.keydownTarget.addEventListener("keydown", Vt.keydownHandler, {
                        capture: Vt.keydownListenerCapture
                    }), Vt.keydownHandlerAdded = !0), c.enableButtons(), c.hideLoading(), c.resetValidationMessage(), l.toast && (l.input || l.footer || l.showCloseButton) ? it(document.body, B["toast-column"]) : rt(document.body, B["toast-column"]), "select" === l.input || "radio" === l.input ? function (e, n) {
                        function o(t) {
                            return re[n.input](i, ae(t), n)
                        }
                        var i = _();
                        v(n.inputOptions) ? (Et(), n.inputOptions.then(function (t) {
                            e.hideLoading(), o(t)
                    ...
                    function (t) {
                        var e = j(),
                            n = R();
                        "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), ie(e, n, t), ne(e, n), G() && oe(e, t.scrollbarPadding), st() || Vt.previousActiveElement || (Vt.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function () {
                            return t.onOpen(n)
                        })
                    }(l), l.toast || (C(l.allowEnterKey) ? l.focusCancel && V(d.cancelButton) ? d.cancelButton.focus() : l.focusConfirm && V(d.confirmButton) ? d.confirmButton.focus() : a(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()), d.container.scrollTop = 0
            })
        },
        update: function (e) {
            var n = {};
            Object.keys(e).forEach(function (t) {
                le.isUpdatableParameter(t) ? n[t] = e[t] : w('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'))
            });
            var t = a({}, ht.innerParams.get(this), n);
            St(this, t), ht.innerParams.set(this, t), Object.defineProperties(this, {
                params: {
    ...
    function ce() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && g("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), se = this;
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
    ...
    ce.prototype.then = function (t) {
        return ht.promise.get(this).then(t)
    }, ce.prototype.finally = function (t) {
        return ht.promise.get(this).finally(t)
    }, a(ce.prototype, ue), a(ce, Rt), Object.keys(ue).forEach(function (e) {
        ce[e] = function () {
            var t;
            if (se) return (t = se)[e].apply(t, arguments)
        }
    }), ce.DismissReason = k, ce.version = "8.14.0";
    var le = ce;
