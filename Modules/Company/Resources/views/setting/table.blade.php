...
<div class="kt-content  kt-grid__item kt-grid__item--fluid p-0" id="kt_content">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        @if (Helper::permission('table-bulk-action-delete') || Helper::permission('table-report'))
        <div class="row py-3">
            <div class="dataTableButton text-right col-md-12 col-sm-12 px-0 d-flex justify-content-center">
               
                @if (Helper::permission('table-report'))
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    @if (Helper::permission('table-add'))
                    <button type="button" id="showModal" onclick="show_modal(modal_title='Add New Table',btn_text='Save')" class="btn btn-brand btn-icon-sm btn-sm">
                    ...
                    <form method="POST" id="saveDataForm">
                        ...
                        <div class="modal-body">
                            <div class="form-group required">
                                <label for="table_no" class="form-control-label">Table No</label>
...
$(document).ready(function () {
    ...
    $(document).on('click','#save-btn',function () {
        ...
        if(id){
            var method = 'update';
            var url = "{{route('table.update')}}";
        }else{
            var method = 'add';
            var url = "{{route('table.store')}}";
        }
    ...
    $(document).on('click','.edit_data',function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#saveDataForm #update_id').val(data.table.id);
                $('#saveDataForm #table_no').val(data.table.table_no);
                $('#saveDataModal').modal({
                    keyboard: false,
                    backdrop: 'static', //make modal static
                });
                $('.modal-title').html('<i class="fas fa-edit"></i> <span>Edit Table Data</span>');
    ...
    $(document).on("click",'#bulk_action_delete',function(e) {
        ...
        if(id.length === 0) //tell us if the array is empty
        {
            ...
            var url = "{{route('table.bulkaction')}}";
