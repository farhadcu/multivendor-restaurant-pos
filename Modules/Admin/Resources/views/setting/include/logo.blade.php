<div class="tile">
    <form action="{{ route('admin.setting') }}" method="POST" role="form" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
                <div class="col-3">
                    @if (config('settings.site_logo') != null)
                        <img src="{{ asset(FOLDER_PATH.LOGO.config('settings.site_logo')) }}" id="logoImg" style="width: 80px; height: auto;">
                    @else
            ...
            <div class="row mt-4">
                <div class="col-3">
                    @if (config('settings.site_favicon') != null)
                        <img src="{{ asset(FOLDER_PATH.LOGO.config('settings.site_favicon')) }}" id="faviconImg" style="width: 80px; height: auto;">
                    @else
