...
<div class="kt-content  kt-grid__item kt-grid__item--fluid p-0" id="kt_content">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        @if (Helper::permission('company-method-bulk-action-delete') || Helper::permission('company-method-report'))
        <div class="row py-3">
            <div class="dataTableButton text-right col-md-12 col-sm-12 px-0 d-flex justify-content-center">
               
                @if (Helper::permission('company-method-report'))
                ...
                @endif
                @if (Helper::permission('company-method-bulk-action-delete'))
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    @if (Helper::permission('company-method-add'))
                    <button type="button" id="showModal" onclick="show_modal(modal_title='Add New Method',btn_text='Save')" class="btn btn-brand btn-icon-sm btn-sm">
                        ...
                        <form method="POST" id="form-filter" class="m-form m-form--fit m--margin-bottom-20" role="form">
                            <div class="row align-items-center">
                                <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                    <label>Method</label>
                                    <input type="text" class="form-control" name="method" id="method" placeholder="Enter method name" />
                                </div>
                                <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                    <label>Module</label>
                                    <select  class="form-control selectpicker" name="module" id="module" data-live-search="true" data-live-search-placeholder="Search" title="Select Please"></select>
                                </div>
                                <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                    <div class="mt-25px">    
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" id="saveDataForm">
                        @csrf
                        <input type="hidden" class="form-control" name="method_id" id="update_id">
                        <div class="modal-body">
                            <div class="form-group row  required">
                                <div class="col-lg-6">
                                    <label for="method_name" class="form-control-label">Method Name</label>
                                    <input type="text" class="form-control" name="method_name" id="method_name" placeholder="Enter method name" onkeyup="url_generator(this.value, output_id='method_slug')">
                                </div>
                                <div class="col-lg-6">
                                    <label for="method_slug" class="form-control-label">Method Slug</label>
                                    <input type="text" class="form-control" name="method_slug" id="method_slug" >
                                </div>
                            </div>
                            <div class="form-group row  required">
                                <div class="col-lg-6">
                                    <label for="module_id" class="form-control-label">Module</label>
...
$(document).ready(function () {
    ...
    var table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('admin.company.method.list')}}",
            "type": "POST",
            "data": function (data) {
    ...
    buttons: [     
            ...
            },
            {
                extend: 'excel',
                title: "{{ucwords($sub_title)}}",
                filename: 'company-method-report',
                exportOptions: {
                    @if (Helper::permission('company-method-bulk-action-delete'))
                    columns: [1,2,3]
                    @else
    ...
    $(document).on('click','#save-btn',function () {
        ...
        if(id){
            var method = 'update';
            var url = "{{route('admin.company.method.update')}}";
        }else{
            var method = 'add';
            var url = "{{route('admin.company.method.store')}}";
        }
    ...
    $(document).on('click','.edit_data',function () {
        ...
        $.ajax({
            url: "{{route('admin.company.method.edit')}}",
            type: "POST",
            ...
            success: function (data) {
                ...
                $('.modal-title').html('<i class="fas fa-edit"></i> <span>Edit Method Data</span>');
    ...
    $(document).on('click','.delete_data',function () {
        ...
        var id  = $(this).data('id');
        var url = "{{route('admin.company.method.delete')}}";
        Swal.fire({
            title: 'Are you sure?',
    ...
    $(document).on("click",'#bulk_action_delete',function(e) {
        ...
        if(id.length === 0) //tell us if the array is empty
        {
            ...
            var url = "{{route('admin.company.method.bulkaction')}}";
            Swal.fire({
                title: 'Are you sure?',
                text: "You won't be able to revert this!",
                type: 'warning',
...
function get_module_list(){
    ...
    $.ajax({
        url: "{{route('admin.company.module.parentModuleList')}}",
        type: "POST",
        success: function (data) {
            if (data) {
                $('#form-filter #module').html(data);
