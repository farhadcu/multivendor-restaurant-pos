            ...
            <div class="kt-portlet__body pt-0">
                <div class="col-md-12" id="store-role-permission">
                    <fieldset>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <select  class="form-control selectpicker" name="branch_id" id="branch_id" data-live-search="true" data-live-search-placeholder="Search" title="Select Please"></select>
                            </div>
                            <div class="col-md-3 required mb-2">
                                <label for="role_id">Role</label>
                                <select  class="form-control selectpicker" name="role_id" id="role_id" data-live-search="true" data-live-search-placeholder="Search" title="Select Please"></select>
                            </div>
                            <div class="col-md-3 required mb-2">
                    ...
                    <fieldset id="password_section">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-3 required mb-2">
...
$(document).ready(function(){
 ...
 $(document).on('click','#save-btn',function () {
    var url = "{{route('admin.company.user.store')}}";
    $.ajax({
        url: url,
        type: "POST",
